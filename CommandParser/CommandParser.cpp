...
void CommandParser::parseCommand(String command) {
	...
	if (command.startsWith("POSITION")) {
		Serial.println("Received a POSITION command.");
		angleStr = command;
		...
		Serial.println("Received a GRIPPER command.");

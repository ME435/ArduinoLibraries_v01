 ...
 * http://sites.google.com/site/me435spring2013
 */
...
#define DEFAULT_TEAM_NUMBER 4  // Used initially as a placeholder if EEPROM is empty.
...
void setup() {
  ...
  // Defaulting to having the servo arm detached.  Could default to attached.
  // armServos.attach();
}
...
void teamNumberChangeRequestCallback(byte teamNumber) {
  if(digitalRead(PIN_TEAM_CHANGE_ENABLE)) {
    ...
    // Pin is low.  Change to the new team number.
